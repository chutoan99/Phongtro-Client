		...
		<section className='section section-support'>
			<div className='section-content clearfix'>
				...
				<div className='list-support clearfix'>
					<div className='list-support-title'>Liên hệ với chúng tôi nếu bạn cần hỗ trợ:</div>
					{supportResources.lists.map((item, index) => (
						<div className='support-item' key={index}>
							...
							<a rel='nofollow' target='_blank' href='https://zalo.me/0917686101'>
								{item.zalo}
							</a>
						</div>
					))}
