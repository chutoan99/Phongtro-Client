...
import { PostModel } from '../modules/post/interfaces'
				...
				return (
					<li
						...
						<figure className='post-thumb'>
							...
							<span className='post-save js-btn-save' data-post-id='212446' title='Lưu tin này'>
								<i></i>
							</span>
						</figure>
						<div className='post-meta'>
							...
							<div className='meta-row clearfix'>
								...
								<a rel='nofollow' target='_blank' href='tel:0918180057' className='btn-quick-call'>
									Gọi: {item.user.phone}
								</a>
							</div>
						</div>
